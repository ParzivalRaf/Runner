...
try:
    ...
    export("Casual2", "CR_Rookie.fbx")
    export("Adventurer", "CR_PE.fbx")
    export("Suit", "CR_Principal.fbx")
    open("/private/tmp/campus_men_done.txt", "w").write("done\n")
except Exception:
    open("/private/tmp/campus_men_error.txt", "w").write(traceback.format_exc())
